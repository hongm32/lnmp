...
Install_PHP_52()
{
    ...
    sed -i 's/post_max_size = 8M/post_max_size = 512M/g' /usr/local/php/etc/php.ini
    ...
    sed -i 's/default_socket_timeout = 60/default_socket_timeout = 600/g' /usr/local/php/etc/php.ini
    sed -i 's/memory_limit = 128M/memory_limit = 2048M/g' /usr/local/php/etc/php.ini
...
#No ZendGuardLoader for PHP 7.0
...
eof
    ...
    cd ${cur_dir}/src
    \cp ${cur_dir}/conf/p.php /home/wwwroot/default/p.php
