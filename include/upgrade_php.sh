...
Upgrade_PHP()
{
    ...
    if echo "${php_version}" | grep -Eqi '^5.2.';then
        ...
        Upgrade_PHP_556
     elif echo "${php_version}" | grep -Eqi '^7.0.';then
        Upgrade_PHP_70
    fi
}
