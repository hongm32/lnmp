...
clear
echo "+-----------------------------------------------------------------------+"
echo "|           Install PHP 5.2.17 for LNMP, Written by XXueHong             |"
echo "+-----------------------------------------------------------------------+"
...
cd ${cur_dir}/src
Download_Files http://218.4.138.116:807/file.php/1/soft/web/php/php-5.2.17.tar.gz php-5.2.17.tar.gz
Download_Files http://218.4.138.116:807/file.php/1/soft/web/phpfpm/php-5.2.17-fpm-0.5.14.diff.gz php-5.2.17-fpm-0.5.14.diff.gz
...
cd ${cur_dir}/src
if [ "${Is_64bit}" = "y" ] ; then
    Download_Files http://218.4.138.116:807/file.php/1/soft/web/zend/ZendOptimizer-3.3.9-linux-glibc23-x86_64.tar.gz
    ...
    Download_Files http://218.4.138.116:807/file.php/1/soft/web/zend/ZendOptimizer-3.3.9-linux-glibc23-i386.tar.gz
